...
import com.ncs.marioapp.databinding.FragmentRoundQuestionBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class RoundQuestionFragment : Fragment() {
    private lateinit var binding: FragmentRoundQuestionBinding
    private lateinit var question: Question
    private var onAnswerSubmitted: ((Answer) -> Unit)? = null
    private var selectedAnswer: String = ""

    companion object {
        fun newInstance(question: Question, onAnswerSubmitted: (Answer) -> Unit): RoundQuestionFragment {
            val fragment = RoundQuestionFragment()
    ...
    override fun onCreateView(
        ...
        binding = FragmentRoundQuestionBinding.inflate(inflater, container, false)
        return binding.root
    }
